...
def store_intermediate_results(opt_result, iteration, filename='/home/arawa/Shabaz_simulation/figure_7_ak/Bayesian_optimization/bo_resultsFV.txt'):
    try:
...
try:
    ...
    with open('/home/arawa/Shabaz_simulation/figure_7_ak/Bayesian_optimization/bo_resultsFV.txt', 'w') as f:
